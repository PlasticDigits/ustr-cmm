...
- **Issuance cards**: `+ Outstanding − CMM-owned = Available Supply` for UST1, USTR, cLUNC, cUSTC. Available feeds CR CMM Liabilities. CMM-held protocol tokens appear as Total-only asset rows.
