...
Companion: [#11](https://gitlab.com/PlasticDigits2/ustr-cmm/-/issues/11). Numerator prices including vFDUSD: [#10](https://gitlab.com/PlasticDigits2/ustr-cmm/-/issues/10) / [frontend-vfdusd-oracle](../frontend-vfdusd-oracle/SKILL.md). Economics tiers: [docs/ECONOMICS.md](../../docs/ECONOMICS.md).
...
5. **No wrap double-count:** cLUNC/cUSTC are supply cards only — not tokenlist holdings, not CR assets. Native LUNC/USTC already count.
6. **UST1 is not an asset.** Do not add it to `tokenlist` balance fetch.
