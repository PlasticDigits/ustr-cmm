...
| [frontend-ust1-ratios](./frontend-ust1-ratios/SKILL.md) | Live UST1 / wrap / USTR issuance; CR = CR CMM Assets / CR CMM Liabilities; [#11](https://gitlab.com/PlasticDigits2/ustr-cmm/-/issues/11) revised by [#16](https://gitlab.com/PlasticDigits2/ustr-cmm/-/issues/16) |
...
| [frontend-treasury-available-supply](./frontend-treasury-available-supply/SKILL.md) | CMM-owned inventory, Total vs CR CMM assets/liabilities, protocol-leg haircut, gated Key Ratios color tiers ([#16](https://gitlab.com/PlasticDigits2/ustr-cmm/-/issues/16)) |
...
| [frontend-treasury-assets-layout](./frontend-treasury-assets-layout/SKILL.md) | Tablet-safe Treasury Assets grid / tiles; wrap values instead of ellipsis; 3-col only at `xl` ([#21](https://gitlab.com/PlasticDigits2/ustr-cmm/-/issues/21)) |
