...
| [frontend-treasury-cl8y-holdings](./frontend-treasury-cl8y-holdings/SKILL.md) | CL8Y indexer catalog vs tokenlist pins; LCD-only hold signal; no factory crawl into CR ([#18](https://gitlab.com/PlasticDigits2/ustr-cmm/-/issues/18)) |
