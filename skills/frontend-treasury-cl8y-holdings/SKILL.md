...
description: >-
  ...
  tokenlist pins (GitLab #18). Use when adding type:lp pins, indexer ingest,
...
**Held + pinned (LCD 2026-08-25):** UST1/USTR, UST1/cUSTC, UST1/SpaceUSD — see [frontend-treasury-lp-nav](../frontend-treasury-lp-nav/SKILL.md) and tokenlist `1.3.2`.
...
6. **Protocol tokens** (UST1, USTR, cLUNC, cUSTC) stay out of CR numerator **and** are not the CR denominator (denominator is UST1 **available** supply).
